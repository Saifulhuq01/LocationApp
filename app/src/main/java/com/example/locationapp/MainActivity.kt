...
fun LocationDisplay(locationUtils: LocationUtils,
    ...
    val requestPemissionLauncher = rememberLauncherForActivityResult(
        ...
        onResult = { permission ->
            if (permission[Manifest.permission.ACCESS_COARSE_LOCATION]==true
                ...
                if (rationalRequired){
                    ...
                    Toast.makeText(context,"Location Permission is requires. Please enable it in the Android Setting",
                        Toast.LENGTH_LONG).show()
                }
            }
    ...
    Column (modifier = Modifier.fillMaxSize(), horizontalAlignment = Alignment.CenterHorizontally, verticalArrangement = Arrangement.Center){
        ...
        Button(onClick = { 
            if (locationUtils.hasLocationPermission(context)){
                ...
                requestPemissionLauncher.launch(
